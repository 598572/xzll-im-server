...
package com.xzll.client.json.client_dev_555;
 ...
 * @Description:
 */
public class WebsocketClientHandler555 extends SimpleChannelInboundHandler<Object> {
    private final WebSocketClientHandshaker handshaker;
    private ChannelPromise handshakeFuture;

    public static List<String> msgIds = new ArrayList<>();

    public WebsocketClientHandler555(WebSocketClientHandshaker handshaker) {
...
//      }
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (frame instanceof TextWebSocketFrame) {
            ...
            System.out.println("用户：（ " + WebsocketClient555.VALUE + " ），接收到TextWebSocketFrame消息，消息内容是: " + textFrame.text());
            ...
            if (imBaseResponse.getUrl().equals(ImSourceUrlConstant.C2C.GET_BATCH_MSG_ID)) {
                ...
                if (!CollectionUtils.isEmpty(msgIds)) {
                    WebsocketClientHandler555.msgIds.addAll(msgIds);
                    WebsocketClient555.getMsgFlag = false;
                }
