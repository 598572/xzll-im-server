package com.xzll.connect.test.client1.protobuf;
//
...
//        this.ip = ip;
//        this.port = port;
//        uriStr = "ws://" + ip + ":" + port + "/websocket/?userId=101";//123455
//    }
//
...
//                    BinaryWebSocketFrame byteFrame = new BinaryWebSocketFrame(byteBuf1);
//
//                    //二进制
//                    channelFuture.channel().writeAndFlush(byteFrame);
//                    //文本消息
//                    //channelFuture.channel().writeAndFlush(new TextWebSocketFrame("二进制消息: " + s));
//
//                    channelFuture.addListener((ChannelFutureListener) lis ->
//                            log.info("客户端手动发消息成功={}", s));
//                }
//            }
//        }).start();
//
